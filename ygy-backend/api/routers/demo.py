...
from common.config import STORE_A, STORE_B, STORE_C, DELIVERY_A, DELIVERY_B, DELIVERY_C, ORDER_A_MENU, ORDER_B_MENU, ORDER_C_MENU, PACKAGE_20826_ORDER_A_ID, PACKAGE_20816_ORDER_A_ID
