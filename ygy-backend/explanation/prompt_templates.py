...
작성 규칙:
1. 세 text 값은 모두 1~3개의 짧은 개조식 문장으로 작성하세요. 각 줄은 반드시 "• "로 시작하고 줄바꿈(\n)으로 구분하세요.
2. 제목, 인사, 도입 문장, 장황한 설명은 쓰지 마세요. 다만 "• 조리 기준은 20분이에요."처럼 자연스러운 짧은 서술식은 사용하세요. "• 조리 기준: 20분", "• 포장 준비: 0분"처럼 항목명과 숫자만 나열하지 마세요.
...
8. 설명이 가능한 근거가 부족하면 그 사실을 짧고 정직한 개조식 문장으로 안내하세요.
