(() => {
  ...
  const initialState = () => ({
    ...
    packages: {
      990: { package_id: 990, rider_id: null, package_type: 'BUNDLE', status: 'OFFERED', bundle_size: 2, score: 72.4, package_revenue: 6800, hourly_revenue: 20400, order_ids: [8891, 8892], route_detail: [{ order_id: 8891, type: 'pickup', sequence: 1 }, { order_id: 8892, type: 'pickup', sequence: 2 }, { order_id: 8891, type: 'dropoff', sequence: 3 }, { order_id: 8892, type: 'dropoff', sequence: 4 }], score_detail: { no_harm: { passed: true, single_eta_min: 34, bundle_eta_min: 36, single_food_sitting_min: 8, bundle_food_sitting_min: 3, single_hourly_revenue: 16800, bundle_hourly_revenue: 20400, reason: '고객 도착시간은 허용 범위 안이며, 음식 방치시간과 라이더 수익이 모두 개선되었습니다.' } }, created_at: '2026-08-16T10:00:00Z' },
