...
if (controlRoot) {
  controlRoot.innerHTML = mockMode
    ...
    : '<section class="control-subpanel"><h3>실제 서버 조회 모드</h3><p style="color:#b7b7c1;font-size:11px;margin:0;line-height:1.6">실제 Oracle DB의 주문 118, 매장 781·467·273, 배정 라이더 rider_102·103·105를 표시합니다. 데이터 생성·초기화·가상 시나리오는 실행하지 않습니다.</p></section>';
}
