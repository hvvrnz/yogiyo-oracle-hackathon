(() => {
  ...
  const renderSvgMap = (
    ...
    /*
     * Kakao Map → SVG fallback 시
     * 이전 지도 layer가 위를 덮지 않도록 숨깁니다.
     */
  ...
  window.Yogiyo.renderSvgMap =
    renderSvgMap;

  window.Yogiyo.renderMap =
    renderMap;
})();